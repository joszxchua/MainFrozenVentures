...
export const MenuDropdown = () => {
  ...
  return (
    <div className="fixed top-[72px] right-0 rounded-bl-lg bg-white border-l-2 border-b-2 border-purple-200 p-5">
