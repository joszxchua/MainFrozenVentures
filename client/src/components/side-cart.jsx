...
export const SideCart = forwardRef(
  ({ closeSideCart, cartClick, shopClick }, ref) => {
    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col justify-between ">
          <div
            className={`min-h-[80vh] max-h-[80vh] overflow-y-auto ${
              cartItems.length === 0
          ...
          >
            ...
            {cartItems && cartItems.length > 0 ? (
              ...
              <div className="flex flex-col items-center gap-5">
                <div className="flex justify-center gap-5 text-4xl text-purple-200">
                  <FontAwesomeIcon icon={faIceCream} />
                  <p className="font-bold">Empty Cart</p>
                </div>
                <p className="text-xl text-center font-semibold">
                  It seems like your cart is empty, try venturing the shop
                </p>
                <button
                  onClick={shopClick}
                  className="w-fit font-bold text-lg px-5 py-1 bg-purple-200 text-white rounded-md border-2 border-purple-200 hover:text-purple-200 hover:bg-white duration-300 ease-in-out"
                >
                  Shop
                </button>
              </div>
